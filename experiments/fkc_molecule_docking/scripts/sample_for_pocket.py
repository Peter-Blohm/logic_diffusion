...
if __name__ == '__main__':
    ...
    DEFAULT_RESULT_PATH = str(EXPERIMENT_DIR / 'outputs_pdb')
    ...
    parser.add_argument('--experiment_dir', type=str, default=str(EXPERIMENT_DIR), help="root directory where all experiments are stored")
